...
//Agregar existencias
/*function agregar(){
    let añadirNom = prompt("Nombre del producto")
    let añadirCant = prompt("ingrese la cantidad que llego")
    let cant= parseInt(añadirCant)
    for (i=0; i<arreglo.length; i++){
    if(arreglo[i]==añadirNom){
        precio+=cant
        arreglo[i]=[producto,cant,cantidad,categoria,posicion]
        imp()
        }
}
}
...
crear1.innerText = 
`
Hay en total ${contador} productos en la tienda
`
parrafo.appendChild(crear1)
}
